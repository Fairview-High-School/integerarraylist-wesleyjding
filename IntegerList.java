public interface IntegerList extends List<Integer> {
    ...
    //You will implement the methods from List in ArrayList, however, you can just replace every instance of E with Integer
    // when implementing them in your ArrayList class.
